...
public class Developer {
	...
	public String getBitcoin() {return bitcoin;}
	
	public void setBitcoin(String bitcoin) {
		if(bitcoin!=null && bitcoin.length()>0)
			this.bitcoin = bitcoin;
	}
	public Long getRazDate() {return razDate;}
	public void setRazDate(Long razDate) {this.razDate = razDate;}
	
	public String getIdPlan() {return idPlan;}
	public void setIdPlan(String idPlan) {
		if(idPlan==null)
			this.idPlan=System.getProperty("DEFAULT_OFFER_START");
		else
			this.idPlan = idPlan;
	}
	...
	public void setPassword(String password) {	
		if(password==null)
			password=String.format("%x", new Date().getTime());
	...
	/**
	 * Main constructor of a developer account
	 * @param email email is the id for the database
	 * @param pass password would be null when an account is registered by facebook
	 * @param bitcoin @see http://en.wikipedia.org/wiki/Bitcoin
	 */
	public Developer(String email,String pass,String idPlan){
		this.setEmail(email);
	...
	/**
	 * Return the string version of a developer account
	 * @see http://www.javabeat.net/2007/08/overriding-the-tostring-method-in-object-class/
	 */
	public String toString(){
		String rc="email: "+this.email+"\n"+"credits: "+this.credits+"\nTarifs:"+this.getIdPlan();
		return rc;
	}
}